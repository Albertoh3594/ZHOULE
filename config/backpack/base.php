...
return [
    ...
    */
    ...
    // Comento esta linea para que asi al registarse el nombre lo guarde bien y no de error ya que nombre en mi migracion en obligatorio
    // 'user_model_fqn' => config('auth.providers.users.model'),
    // 'user_model_fqn' => App\User::class, // works on Laravel <= 7
    // Comentando la linea de arriba y descomentando esta para que el nombre funcione
